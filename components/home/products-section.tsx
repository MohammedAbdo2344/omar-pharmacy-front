...
const palette = [
  { card: 'from-blue-100 to-blue-50', icon: 'text-blue-600', badge: 'bg-amber-100 text-amber-700' },
  { card: 'from-amber-100 to-amber-50', icon: 'text-amber-600', badge: 'bg-amber-100 text-amber-700' },
  { card: 'from-indigo-100 to-indigo-50', icon: 'text-indigo-600', badge: 'bg-amber-100 text-amber-700' },
  { card: 'from-rose-100 to-rose-50', icon: 'text-rose-600', badge: 'bg-amber-100 text-amber-700' },
];
        ...
        <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {products.map((product, index) => {
            ...
            return (
              ...
              >
                <div className={`relative bg-linear-to-br ${colors.card} m-2.5 border border-blue-100 rounded-2xl p-6 h-48 flex items-center justify-center overflow-hidden`}>
                  ...
                  {!hasDiscount && (
                    <span className={`absolute top-3 left-3 ${colors.badge} text-[11px] font-bold tracking-wide uppercase px-2.5 py-1 rounded-full`}>
